...
const (
	Publish_Action_FullMethodName = "/publish.Publish/Action"
	Publish_List_FullMethodName   = "/publish.Publish/List"
)
...
func (c *publishClient) Action(ctx context.Context, in *ActionReq, opts ...grpc.CallOption) (*ActionResp, error) {
	out := new(ActionResp)
	err := c.cc.Invoke(ctx, Publish_Action_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publishClient) List(ctx context.Context, in *ListReq, opts ...grpc.CallOption) (*ListResp, error) {
	out := new(ListResp)
	err := c.cc.Invoke(ctx, Publish_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPublishServer) Action(context.Context, *ActionReq) (*ActionResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Action not implemented")
}
func (UnimplementedPublishServer) List(context.Context, *ListReq) (*ListResp, error) {
...
func _Publish_Action_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Publish_Action_FullMethodName,
	}
...
func _Publish_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Publish_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
