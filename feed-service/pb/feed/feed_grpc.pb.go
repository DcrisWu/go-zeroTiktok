...
const (
	Feed_Feed_FullMethodName = "/feed.Feed/Feed"
)
...
func (c *feedClient) Feed(ctx context.Context, in *FeedReq, opts ...grpc.CallOption) (*FeedResp, error) {
	out := new(FeedResp)
...
func (UnimplementedFeedServer) Feed(context.Context, *FeedReq) (*FeedResp, error) {
